...
| :--- | :--- | :--- |
| 🛡️ **3D Portfolio** | [**Live**](https://new-portfolio-weld-delta.vercel.app/) | Interactive 3D environment with physics-based character controllers and React Context state management. |
| 🏨 **TravelO** | [**Live**](https://travel-app-frontend-bc3k.vercel.app/) | Full-stack hotel booking system featuring infinite scroll, JWT auth, and a 3-tier admin dashboard. |
| 🍔 **FoodDash** | [**Live**](https://food-delivery-1wb786q99-anshul-1403s-projects.vercel.app/) | Real-time food ordering platform synchronized with Redux Toolkit and protected by custom JWT middleware. |
| 🏗️ **CRM Architecture** | [**GitHub**](https://github.com/anshul-1403/learnlynk-assignment) | Robust backend service with RLS policies, PostgreSQL schema design, and Supabase Edge Functions. |
